...
function authStyles() {
 ...
 :root{--primary:#6C3AED;--primary-light:#8B5CF6;--dark:#0F0F1A;--dark-2:#1A1A2E;--surface:#1E1E32;--text:#FFF;--text-muted:#A0AEC0;--text-dim:#718096;--gradient-1:linear-gradient(90deg,#6C3AED 0%,#EC4899 100%);--border-subtle:1px solid rgba(255,255,255,0.06);--error:#EF4444;--success:#10B981}
...
<body>
 ...
 <a href="/" class="auth-logo"><img src="/images/splicora-logo-wide.png" alt="Splicora" style="height:40px;"></a>
