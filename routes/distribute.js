...
const PLATFORMS = [
  ...
  { id: 'googledrive', name: 'Google Drive', color: '#4285F4', colorDark: '#5B9BFF', type: 'source_destination', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7.71 3.5L1.15 15l4.58 7.5H12L5.44 11 7.71 3.5zm8.58 0h-6.58l6.58 11h6.58L16.29 3.5zm-.71 12.5l-3.29 5.5h12.58l3.29-5.5H15.58zM8 15l4-6.69L8 2H2l6 13z"/></svg>' },
  { id: 'dropbox', name: 'Dropbox', color: '#0061FF', colorDark: '#3B8BFF', type: 'source_destination', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 2l6 3.75L6 9.5 0 5.75 6 2zm12 0l6 3.75-6 3.75-6-3.75L18 2zM0 13.25L6 9.5l6 3.75L6 17 0 13.25zm18-3.75l6 3.75L18 17l-6-3.75L18 9.5zM6 18.25l6-3.75 6 3.75L12 22l-6-3.75z"/></svg>' },
  { id: 'twitch', name: 'Twitch', color: '#9146FF', colorDark: '#A970FF', type: 'source', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714z"/></svg>' },
  { id: 'heygen', name: 'HeyGen', color: '#5B4EFF', colorDark: '#7B6FFF', type: 'source', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>' },
  { id: 'audiopodcast', name: 'Audio Podcast', color: '#8B5CF6', colorDark: '#A78BFA', type: 'source', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3zM7 12a5 5 0 0 0 10 0h-2a3 3 0 0 1-6 0H7zm4 7.93A7.001 7.001 0 0 1 5 13H3a9.001 9.001 0 0 0 8 8.93V23h2v-1.07A9.001 9.001 0 0 0 21 13h-2a7.001 7.001 0 0 1-6 6.93V17h-2v2.93z"/></svg>' },
  { id: 'videopodcast', name: 'Video Podcast', color: '#F97316', colorDark: '#FB923C', type: 'source', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 2v12h16V6H4zm5 2.5l6 3.5-6 3.5v-7z"/></svg>' },
  { id: 'zoom', name: 'Zoom', color: '#2D8CFF', colorDark: '#4DA3FF', type: 'source', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4.585 6.836a2.5 2.5 0 0 0-2.5 2.5v5.33a2.5 2.5 0 0 0 2.5 2.5h8.33a2.5 2.5 0 0 0 2.5-2.5v-1.94l4.5 3v-8.45l-4.5 3v-1.94a2.5 2.5 0 0 0-2.5-2.5h-8.33z"/></svg>' },
  { id: 'webex', name: 'Webex', color: '#00BCF2', colorDark: '#33D4FF', type: 'source', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>' },
  { id: 'amazon', name: 'Amazon', color: '#FF9900', colorDark: '#FFB347', type: 'destination', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M.045 18.02c.07-.116.36-.235.897-.346 1.672-.346 5.326-.93 8.26-.93 2.97 0 6.04.504 8.26.93.506.1.78.2.897.346.07.093.095.27-.024.46-.164.267-.546.36-1.236.267-3.296-.445-5.786-.667-7.897-.667-2.153 0-4.716.236-7.897.668-.654.093-1.072-.001-1.236-.268-.12-.19-.094-.367-.024-.46zm14.07-4.776c-.394.46-1.21.63-2.062.63-.967 0-1.818-.19-2.585-.576l-.328.47c.813.41 1.756.617 2.912.617.94 0 1.903-.216 2.496-.75l-.433-.391zm5.557-2.394c0-2.79-1.943-4.85-4.738-4.85-2.795 0-4.963 2.132-4.963 5.05 0 3.07 2.244 4.85 5.134 4.85 1.447 0 2.67-.352 3.592-1.046l-.394-.478c-.745.524-1.74.808-3.044.808-2.426 0-4.07-1.474-4.246-3.783h8.494c.098-.464.165-.967.165-1.55z"/></svg>' },
  { id: 'soundcloud', name: 'SoundCloud', color: '#FF5500', colorDark: '#FF7733', type: 'destination', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M1.175 12.225c-.051 0-.094.046-.101.1l-.233 2.154.233 2.105c.007.058.05.098.101.098.05 0 .09-.04.099-.098l.255-2.105-.27-2.154c-.009-.06-.05-.1-.1-.1m-.899.828c-.06 0-.091.037-.104.094L0 14.479l.172 1.282c.013.06.045.094.104.094.057 0 .089-.035.104-.094l.21-1.282-.21-1.332c-.015-.057-.047-.094-.104-.094m1.8-.622c-.064 0-.107.043-.112.1l-.209 2.048.209 2.076c.005.06.048.1.112.1.063 0 .106-.04.116-.1l.24-2.076-.24-2.048c-.01-.057-.053-.1-.116-.1m.899-.143c-.07 0-.119.049-.126.108l-.195 2.191.195 2.156c.007.065.056.108.126.108.069 0 .117-.043.128-.108l.22-2.156-.22-2.191c-.011-.059-.059-.108-.128-.108m.89-.153c-.078 0-.129.054-.137.118L3.56 14.48l.168 2.213c.008.066.059.118.137.118.076 0 .127-.052.14-.118l.192-2.213-.192-2.224c-.013-.064-.064-.118-.14-.118m.89-.103c-.083 0-.138.06-.147.125l-.16 2.327.16 2.246c.009.07.064.125.147.125.082 0 .136-.055.15-.125l.182-2.246-.183-2.327c-.013-.065-.067-.125-.15-.125m.9-.063c-.09 0-.148.065-.156.133l-.149 2.39.149 2.27c.008.073.066.133.156.133.088 0 .147-.06.159-.133l.17-2.27-.17-2.39c-.012-.068-.07-.133-.16-.133m1.198.215c-.1 0-.164.073-.172.145l-.129 2.175.129 2.234c.008.08.072.145.172.145.098 0 .162-.065.175-.145l.148-2.234-.148-2.175c-.013-.072-.077-.145-.175-.145M8.75 9.847c-.107 0-.177.078-.183.153l-.12 4.628.12 2.184c.006.085.076.153.183.153.106 0 .175-.068.187-.153l.135-2.184-.135-4.628c-.012-.075-.081-.153-.187-.153m.9-.002c-.113 0-.186.084-.196.162l-.108 4.63.108 2.143c.01.09.083.162.196.162.11 0 .184-.072.2-.162l.121-2.143-.122-4.63c-.015-.078-.089-.162-.199-.162m.9.003c-.12 0-.193.09-.206.17l-.098 4.627.098 2.098c.013.09.086.17.206.17.118 0 .192-.08.21-.17l.109-2.098-.11-4.628c-.017-.08-.091-.17-.209-.17m.9-.127c-.125 0-.2.095-.216.177l-.088 4.754.088 2.08c.016.095.091.177.216.177.123 0 .2-.082.219-.177l.098-2.08-.098-4.754c-.02-.082-.096-.177-.22-.177m1.204-.248c-.136 0-.217.104-.228.19l-.074 5.002.074 2.038c.011.1.092.19.228.19.133 0 .214-.09.231-.19l.084-2.038-.084-5.002c-.017-.086-.098-.19-.231-.19m.897.093c-.14 0-.225.11-.238.198l-.064 4.91.064 2.003c.013.103.098.198.238.198.138 0 .224-.095.243-.198l.071-2.003-.071-4.91c-.019-.088-.105-.198-.243-.198m1.2-.426c-.03 0-.056.003-.084.01-.035-.64-.416-1.202-.926-1.52-.372-.232-.8-.36-1.256-.36-.157 0-.312.015-.463.045-.066.013-.078.04-.078.08v7.345c0 .042.03.078.072.085.007.001 4.715.002 4.735.002 1.006 0 1.82-.825 1.82-1.843 0-1.02-.814-1.843-1.82-1.843z"/></svg>' },
  { id: 'libsyn', name: 'Libsyn', color: '#2BAC76', colorDark: '#3DD68E', type: 'destination', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-3.5l6-4.5-6-4.5v9z"/></svg>' },
  { id: 'captivate', name: 'Captivate.fm', color: '#1A1A2E', colorDark: '#4A4A6A', type: 'destination', svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3zM5 13h2a5 5 0 0 0 10 0h2a7 7 0 0 1-6 6.92V22h-2v-2.08A7 7 0 0 1 5 13z"/></svg>' }
];
    ...
    <div class="dashboard">
      ...
      <div class="main-content">
        <div class="workflows-header">
          <div>
            <h1><img src="/images/section-icons/A-12.png" alt="" style="height:36px;width:36px;vertical-align:middle;margin-right:8px;border-radius:8px;display:inline-block">Repurpose</h1>
...
router.get('/connections', requireAuth, async (req, res) => {
  ...
  const platformDescriptions = {
    ...
    googledrive: 'Cloud storage & source',
    dropbox: 'Cloud storage & source',
    twitch: 'Live streams & VODs',
    heygen: 'AI video generation',
    audiopodcast: 'RSS audio feeds',
    videopodcast: 'RSS video feeds',
