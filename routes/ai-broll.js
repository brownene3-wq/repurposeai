...
<body>
  <div class="dashboard">
    ...
    <main class="main-content">
      ...
      <div id="quickImportBar" class="input-section broll-container" style="background:var(--surface);border-radius:12px;padding:2rem;margin-bottom:2rem;border:1px solid var(--border-subtle);max-width:1200px;margin-left:auto;margin-right:auto">
