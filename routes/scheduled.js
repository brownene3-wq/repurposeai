...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page-title { font-size: 1.8em; font-weight: 800; background: linear-gradient(90deg, #7C3AED 0%, #A855F7 30%, #EC4899 65%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; width: fit-content; }
