...
.carousel-mockup{width:100%;max-width:900px;height:480px;background:#1c1c32;border-radius:20px;border:1px solid rgba(108,58,237,0.3);display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;box-shadow:0 20px 80px rgba(0,0,0,0.6),0 0 60px rgba(108,58,237,0.15)}
.carousel-mockup::before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(108,58,237,0.1) 0%,rgba(236,72,153,0.05) 50%,rgba(59,130,246,0.08) 100%);z-index:1}
.carousel-mockup::after{content:'';position:absolute;top:0;left:0;right:0;height:1px;background:linear-gradient(90deg,transparent,rgba(108,58,237,0.4),transparent);z-index:1}
.carousel-inner{position:relative;z-index:2;width:100%;height:100%;display:flex;flex-direction:row;padding:0}
.carousel-inner .mock-icon{display:none}
.carousel-inner .mock-title{display:none}
.carousel-inner .mock-desc{display:none}
.carousel-inner .mock-ui{display:none}
.carousel-inner .mock-btn{display:none}
.mock-preview{display:none}
.mock-preview-bar{display:none}
.mock-preview-block{display:none}
.carousel-slide-content{width:100%;height:100%;display:flex;position:relative}
.carousel-video-editor{display:grid;grid-template-columns:1fr 200px;grid-template-rows:1fr 100px;gap:8px;width:100%;height:100%;padding:12px;box-sizing:border-box}
.carousel-main-preview{grid-column:1;grid-row:1;border-radius:12px;overflow:hidden;position:relative;background-size:cover;background-position:center;border:1px solid rgba(108,58,237,0.2)}
.carousel-main-preview::after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,0.4) 0%,rgba(0,0,0,0.2) 50%,rgba(0,0,0,0.5) 100%)}
.carousel-caption-overlay{position:absolute;bottom:20px;left:20px;right:20px;background:rgba(0,0,0,0.8);padding:12px 16px;border-radius:8px;font-size:.85rem;color:#fff;z-index:3;backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,0.1)}
.carousel-side-panel{grid-column:2;grid-row:1;background:linear-gradient(135deg,rgba(108,58,237,0.15),rgba(236,72,153,0.08));border-radius:12px;border:1px solid rgba(108,58,237,0.2);padding:12px;display:flex;flex-direction:column;gap:8px;overflow:hidden}
.carousel-panel-item{height:20px;background:linear-gradient(90deg,rgba(108,58,237,0.3),rgba(108,58,237,0.1));border-radius:4px;animation:pulse 2s ease-in-out infinite}
.carousel-timeline{grid-column:1/3;grid-row:2;background:linear-gradient(135deg,rgba(108,58,237,0.12),rgba(59,130,246,0.08));border-radius:8px;border:1px solid rgba(108,58,237,0.2);display:flex;gap:6px;padding:8px;overflow:hidden;align-items:center}
.carousel-timeline-thumb{width:40px;height:60px;background-size:cover;border-radius:4px;flex-shrink:0;border:1px solid rgba(255,255,255,0.1);opacity:.7}
@keyframes pulse{0%,100%{opacity:0.5}50%{opacity:1}}
.carousel-scheduler-grid{display:grid;grid-template-columns:repeat(2,1fr);grid-template-rows:repeat(3,1fr);gap:10px;width:100%;height:100%;padding:16px}
.carousel-scheduler-cell{background:rgba(108,58,237,0.15);border:1px solid rgba(108,58,237,0.25);border-radius:8px;display:flex;flex-direction:column;justify-content:flex-start;padding:10px;font-size:.7rem;color:var(--text-muted);overflow:hidden}
.carousel-scheduler-cell::before{content:'';display:block;width:16px;height:16px;border-radius:50%;background:var(--primary);margin-bottom:4px;flex-shrink:0}
.carousel-scheduler-label{position:absolute;top:12px;left:16px;font-size:.75rem;color:var(--text-muted);z-index:3}
.carousel-social-icons{display:flex;gap:8px;position:absolute;top:16px;right:16px;z-index:3}
.carousel-social-icon{width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:.85rem;border:1px solid rgba(255,255,255,0.1);background:rgba(0,0,0,0.3);backdrop-filter:blur(10px)}
.carousel-caption-styles{display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:10px;width:100%;height:100%;padding:16px}
.carousel-caption-style-btn{background:rgba(108,58,237,0.15);border:1px solid rgba(108,58,237,0.25);border-radius:8px;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:4px;cursor:default;font-size:.75rem;color:var(--text-muted);font-weight:500}
.carousel-caption-style-btn:nth-child(1){border-color:rgba(236,72,153,0.4);background:rgba(236,72,153,0.12)}
.carousel-caption-style-btn:nth-child(1) span{color:#EC4899;font-weight:600}
.carousel-reframe-layout{display:flex;gap:20px;align-items:center;justify-content:center;width:100%;height:100%}
.carousel-reframe-before{width:420px;height:280px;background-size:cover;background-position:center;border-radius:12px;border:1px solid rgba(108,58,237,0.3);position:relative;overflow:hidden;display:flex;align-items:flex-end;justify-content:center;padding-bottom:12px}
.carousel-reframe-before::after{content:'16:9';position:absolute;bottom:16px;left:50%;transform:translateX(-50%);background:rgba(0,0,0,0.7);padding:4px 12px;border-radius:4px;font-size:.75rem;color:#fff;backdrop-filter:blur(10px)}
.carousel-reframe-after{width:180px;height:320px;background-size:cover;background-position:center;border-radius:12px;border:1px solid rgba(236,72,153,0.4);position:relative;overflow:hidden;display:flex;align-items:flex-end;justify-content:center;padding-bottom:12px}
.carousel-reframe-after::after{content:'9:16';position:absolute;bottom:16px;left:50%;transform:translateX(-50%);background:rgba(0,0,0,0.7);padding:4px 12px;border-radius:4px;font-size:.75rem;color:#fff;backdrop-filter:blur(10px)}
.carousel-broll-layout{display:grid;grid-template-columns:1fr 1fr;gap:20px;padding:20px;width:100%;height:100%}
.carousel-broll-main{background-size:cover;border-radius:12px;border:1px solid rgba(108,58,237,0.3);position:relative;overflow:hidden}
.carousel-broll-panel{display:flex;flex-direction:column;gap:12px;justify-content:center}
.carousel-broll-btn{background:var(--gradient-1);border:none;color:#fff;padding:12px 16px;border-radius:8px;font-size:.85rem;font-weight:600;cursor:default;box-shadow:0 4px 15px rgba(108,58,237,0.3)}
.carousel-broll-thumbs{display:grid;grid-template-columns:1fr;gap:8px;flex:1;overflow:hidden}
.carousel-broll-thumb{background:linear-gradient(135deg,rgba(108,58,237,0.2),rgba(236,72,153,0.1));border-radius:6px;border:1px solid rgba(108,58,237,0.2);height:40px}
.carousel-voice-layout{display:flex;flex-direction:column;gap:20px;padding:24px;width:100%;height:100%}
.carousel-voice-title{font-size:.9rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:.1em;font-weight:600}
.carousel-voice-meter{display:flex;flex-direction:column;gap:10px}
.carousel-voice-meter-label{display:flex;justify-content:space-between;align-items:center;font-size:.8rem;color:var(--text-muted)}
.carousel-voice-meter-bar{width:100%;height:8px;background:rgba(108,58,237,0.15);border-radius:4px;overflow:hidden;border:1px solid rgba(108,58,237,0.2)}
.carousel-voice-meter-fill{height:100%;background:linear-gradient(90deg,var(--primary),var(--accent));width:65%}
.carousel-voice-output{padding:12px;background:rgba(108,58,237,0.1);border-radius:8px;border:1px solid rgba(108,58,237,0.2);font-size:.8rem;color:var(--text-muted);line-height:1.5;margin-top:auto;flex:1;overflow:auto}
...
@media(max-width:768px){
  ...
  .carousel-mockup{height:320px;max-width:100%}
  .carousel-video-editor{grid-template-columns:1fr;padding:8px}
  .carousel-side-panel{display:none}
  .carousel-timeline{grid-column:1}
  .carousel-scheduler-grid{grid-template-columns:1fr;gap:8px;padding:12px}
  .carousel-reframe-layout{flex-direction:column;gap:12px}
  .carousel-reframe-before{width:240px;height:160px}
  .carousel-reframe-after{width:140px;height:250px}
  .carousel-broll-layout{grid-template-columns:1fr;gap:12px;padding:12px}
  .carousel-voice-layout{padding:16px}
    ...
    <div class="hero-content">
      ...
      <div class="carousel-container">
        <div class="carousel" id="carousel">
          <div class="carousel-slide"><div class="carousel-mockup"><div class="carousel-inner"><div class="carousel-slide-content"><div class="carousel-video-editor"><div class="carousel-main-preview" style="background-image:url('https://images.unsplash.com/photo-1559526324-593bc073d938?w=600&h=400&fit=crop')"><div class="carousel-caption-overlay">When you truly understand your customer...</div></div><div class="carousel-side-panel"><div class="carousel-panel-item" style="width:60%"></div><div class="carousel-panel-item"></div><div class="carousel-panel-item" style="width:70%"></div><div class="carousel-panel-item" style="width:50%"></div></div><div class="carousel-timeline"><div class="carousel-timeline-thumb" style="background-image:url('https://images.unsplash.com/photo-1559526324-593bc073d938?w=60&h=80&fit=crop')"></div><div class="carousel-timeline-thumb" style="background-image:url('https://images.unsplash.com/photo-1559526324-593bc073d938?w=60&h=80&fit=crop');opacity:0.5"></div><div class="carousel-timeline-thumb" style="background-image:url('https://images.unsplash.com/photo-1559526324-593bc073d938?w=60&h=80&fit=crop');opacity:0.3"></div></div></div></div></div></div></div>
          <div class="carousel-slide"><div class="carousel-mockup"><div class="carousel-inner"><div class="carousel-slide-content"><div class="carousel-video-editor"><div class="carousel-main-preview" style="background-image:url('https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=600&h=400&fit=crop')"><div class="carousel-caption-overlay" style="background:linear-gradient(90deg,rgba(236,72,153,0.8),rgba(59,130,246,0.8))">Your content here with trending captions</div></div><div class="carousel-side-panel" style="background:linear-gradient(135deg,rgba(245,158,11,0.15),rgba(239,68,68,0.08))"><div class="carousel-panel-item" style="background:linear-gradient(90deg,rgba(245,158,11,0.4),rgba(245,158,11,0.2))"></div><div class="carousel-panel-item" style="background:linear-gradient(90deg,rgba(239,68,68,0.4),rgba(239,68,68,0.2))"></div><div class="carousel-panel-item" style="background:linear-gradient(90deg,rgba(59,130,246,0.4),rgba(59,130,246,0.2))"></div></div><div class="carousel-timeline" style="background:linear-gradient(135deg,rgba(245,158,11,0.12),rgba(239,68,68,0.08))"><span style="flex:1;height:60px;background:linear-gradient(135deg,rgba(245,158,11,0.3),rgba(245,158,11,0.15));border-radius:6px"></span><span style="flex:1;height:60px;background:linear-gradient(135deg,rgba(239,68,68,0.3),rgba(239,68,68,0.15));border-radius:6px"></span></div></div></div></div></div>
          <div class="carousel-slide"><div class="carousel-mockup"><div class="carousel-inner"><div class="carousel-slide-content"><div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;padding:20px;box-sizing:border-box"><div class="carousel-reframe-layout"><div class="carousel-reframe-before" style="background-image:url('https://images.unsplash.com/photo-1536240478700-b869070f9279?w=700&h=400&fit=crop')"></div><div style="display:flex;flex-direction:column;align-items:center;gap:8px"><span style="color:var(--text-muted);font-size:0.8rem;font-weight:600">Auto-Reframe to</span><span style="background:var(--gradient-1);color:#fff;padding:6px 12px;border-radius:6px;font-size:0.75rem;font-weight:700">9:16</span></div><div class="carousel-reframe-after" style="background-image:url('https://images.unsplash.com/photo-1536240478700-b869070f9279?w=300&h=500&fit=crop')"></div></div></div></div></div></div>
          <div class="carousel-slide"><div class="carousel-mockup"><div class="carousel-inner"><div class="carousel-slide-content"><div style="width:100%;height:100%;display:flex;flex-direction:column;padding:16px;box-sizing:border-box;gap:12px"><div style="display:flex;justify-content:space-between;align-items:center"><span style="color:var(--text-muted);font-size:0.85rem;font-weight:600">B-Roll Suggestions</span><span style="background:var(--gradient-1);color:#fff;padding:4px 10px;border-radius:4px;font-size:0.7rem;font-weight:700">AI Match</span></span></div><div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;flex:1"><div class="carousel-broll-layout"><div class="carousel-broll-main" style="background-image:url('https://images.unsplash.com/photo-1485846234645-a62644f84728?w=300&h=200&fit=crop')"></div><div class="carousel-broll-panel"><button class="carousel-broll-btn">+ Add B-Roll</button><div class="carousel-broll-thumbs"><div class="carousel-broll-thumb"></div><div class="carousel-broll-thumb"></div></div></div></div></div></div></div></div></div>
          <div class="carousel-slide"><div class="carousel-mockup"><div class="carousel-inner"><div class="carousel-slide-content"><div style="width:100%;height:100%;display:flex;flex-direction:column;padding:16px;box-sizing:border-box;gap:12px"><div style="display:flex;justify-content:space-between;align-items:center"><span style="color:var(--text-muted);font-size:0.85rem;font-weight:600;text-transform:uppercase;letter-spacing:0.05em">April 2026</span><div class="carousel-social-icons"><div class="carousel-social-icon" style="background:rgba(255,0,0,0.2);border-color:rgba(255,0,0,0.3)">▶</div><div class="carousel-social-icon" style="background:rgba(236,72,153,0.2);border-color:rgba(236,72,153,0.3)">📷</div><div class="carousel-social-icon" style="background:rgba(59,130,246,0.2);border-color:rgba(59,130,246,0.3)">in</div></div></div><div style="display:grid;grid-template-columns:repeat(7,1fr);gap:6px;flex:1"><div style="font-size:0.65rem;color:var(--text-dim);font-weight:600;text-align:center">Mon</div><div style="font-size:0.65rem;color:var(--text-dim);font-weight:600;text-align:center">Tue</div><div style="font-size:0.65rem;color:var(--text-dim);font-weight:600;text-align:center">Wed</div><div style="font-size:0.65rem;color:var(--text-dim);font-weight:600;text-align:center">Thu</div><div style="font-size:0.65rem;color:var(--text-dim);font-weight:600;text-align:center">Fri</div><div style="font-size:0.65rem;color:var(--text-dim);font-weight:600;text-align:center">Sat</div><div style="font-size:0.65rem;color:var(--text-dim);font-weight:600;text-align:center">Sun</div><div style="background:rgba(108,58,237,0.2);border-radius:4px;border:1px solid rgba(108,58,237,0.3);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:var(--text-muted)">1</div><div style="background:rgba(108,58,237,0.3);border-radius:4px;border:1px solid rgba(108,58,237,0.4);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:var(--primary-light)">2</div><div style="background:rgba(108,58,237,0.15);border-radius:4px;border:1px solid rgba(108,58,237,0.25);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:var(--text-muted)">3</div><div style="background:rgba(236,72,153,0.2);border-radius:4px;border:1px solid rgba(236,72,153,0.3);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:var(--text-muted)">4</div><div style="background:rgba(108,58,237,0.2);border-radius:4px;border:1px solid rgba(108,58,237,0.3);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:var(--text-muted)">5</div><div style="background:rgba(108,58,237,0.35);border-radius:4px;border:1px solid rgba(108,58,237,0.4);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:var(--primary-light)">6</div><div style="background:rgba(108,58,237,0.1);border-radius:4px;border:1px solid rgba(108,58,237,0.2);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:var(--text-muted)">7</div></div></div></div></div></div>
          <div class="carousel-slide"><div class="carousel-mockup"><div class="carousel-inner"><div class="carousel-slide-content"><div style="width:100%;height:100%;display:flex;flex-direction:column;padding:20px;box-sizing:border-box;gap:16px;justify-content:center"><div style="display:flex;justify-content:space-between;align-items:center"><span style="color:var(--text-muted);font-size:0.85rem;font-weight:600;text-transform:uppercase;letter-spacing:0.1em">Voice Profile</span><button style="background:var(--gradient-1);color:#fff;border:none;padding:6px 12px;border-radius:6px;font-size:0.75rem;font-weight:700;cursor:default">Train Now</button></div><div style="display:flex;flex-direction:column;gap:8px"><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-size:0.75rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.05em">Tone</span><span style="font-size:0.75rem;color:var(--primary-light)">Professional</span></span></div><div style="height:8px;background:rgba(108,58,237,0.15);border-radius:4px;overflow:hidden;border:1px solid rgba(108,58,237,0.2)"><div style="height:100%;background:linear-gradient(90deg,var(--primary),var(--accent));width:65%"></div></div></div><div style="display:flex;flex-direction:column;gap:8px"><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-size:0.75rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.05em">Engagement</span><span style="font-size:0.75rem;color:var(--primary-light)">Conversational</span></span></div><div style="height:8px;background:rgba(108,58,237,0.15);border-radius:4px;overflow:hidden;border:1px solid rgba(108,58,237,0.2)"><div style="height:100%;background:linear-gradient(90deg,var(--primary),var(--accent));width:75%"></div></div></div><div style="padding:12px;background:rgba(108,58,237,0.1);border-radius:8px;border:1px solid rgba(108,58,237,0.2);font-size:0.8rem;color:var(--text-muted);line-height:1.5">Your brand voice trained on 12 pieces. Sounds authentic to you.</div></div></div></div></div>
        </div>
      </div>
