    ...
    <div class="hero-content">
      ...
      <div class="carousel-container">
        <div class="carousel" id="carousel">
          ...
          <div class="carousel-slide"><div class="carousel-showcase layout-centered"><div class="carousel-screen carousel-screen-main"><div class="carousel-screen-topbar"><div class="carousel-screen-dot"></div><div class="carousel-screen-dot"></div><div class="carousel-screen-dot"></div><span style="flex:1;text-align:center;font-size:.7rem;color:var(--text-muted)">Smart Shorts — AI Clipping</span></div><div style="position:relative;flex:1;overflow:hidden;background:#0d0d14"><video src="/public/videos/ai-clipping-v3.mp4" autoplay muted loop playsinline style="width:100%;height:100%;object-fit:cover;display:block"></video><div style="position:absolute;bottom:0;left:0;right:0;padding:20px 24px;background:linear-gradient(transparent,rgba(0,0,0,0.8))"><div style="display:inline-flex;align-items:center;gap:6px;padding:6px 14px;border-radius:8px;background:rgba(108,58,237,0.85);backdrop-filter:blur(8px);font-size:.75rem;font-weight:700;color:#fff;margin-bottom:8px">&#x2702;&#xFE0F; AI-Powered Clipping</div><div style="font-size:.85rem;color:rgba(255,255,255,0.9);font-weight:500">Drop a long video &#x2192; Get viral-ready shorts for every platform</div></div></div></div></div></div>
          <!-- Slide 2: AI Captions -->
