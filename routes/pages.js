...
.carousel-container{position:relative;margin-top:4rem;max-width:1050px;margin-left:50%;transform:translateX(-50%);width:90vw;padding:0 40px;box-sizing:border-box}
.carousel{display:flex;overflow:hidden;transition:transform .5s ease-in-out}
.carousel-slide{flex:0 0 100%;display:flex;justify-content:center;align-items:center;min-height:560px}
...
.carousel-screen-main{width:100%;max-width:880px;aspect-ratio:16/9;display:flex;flex-direction:column}
    ...
    <div class="hero-content">
      ...
      <div class="carousel-container">
        <div class="carousel" id="carousel">
          ...
          <div class="carousel-slide"><div class="carousel-showcase layout-editor"><div class="carousel-screen carousel-screen-main"><div class="carousel-screen-topbar"><div class="carousel-screen-dot"></div><div class="carousel-screen-dot"></div><div class="carousel-screen-dot"></div><span style="flex:1;text-align:center;font-size:.7rem;color:var(--text-muted)">Smart Shorts — AI Clipping</span></div><div class="carousel-screen-body"><div class="carousel-video-area"><div class="carousel-video-placeholder"><video src="/public/videos/ai-clipping-v3.mp4" autoplay muted loop playsinline></video></div></div><div class="carousel-sidebar"><div class="carousel-sidebar-item"><div class="carousel-sidebar-thumb"></div><span>Clip 1</span><span class="carousel-sidebar-badge">0:15</span></div><div class="carousel-sidebar-item"><div class="carousel-sidebar-thumb"></div><span>Clip 2</span><span class="carousel-sidebar-badge">0:32</span></div><div class="carousel-sidebar-item"><div class="carousel-sidebar-thumb"></div><span>Clip 3</span><span class="carousel-sidebar-badge">0:45</span></div><div class="carousel-sidebar-item"><div class="carousel-sidebar-thumb"></div><span>Clip 4</span><span class="carousel-sidebar-badge">1:00</span></div></div></div><div class="carousel-timeline-bar"><div class="carousel-timeline-clip active"><div class="carousel-timeline-clip-inner"></div><div class="carousel-timeline-scrubber"></div></div><div class="carousel-timeline-clip"><div class="carousel-timeline-clip-inner" style="background:linear-gradient(135deg,rgba(236,72,153,0.15),rgba(245,158,11,0.1))"></div></div><div class="carousel-timeline-clip"><div class="carousel-timeline-clip-inner" style="background:linear-gradient(135deg,rgba(59,130,246,0.15),rgba(108,58,237,0.1))"></div></div></div></div></div></div>
          <!-- Slide 2: AI Captions -->
