...
<nav><div class="nav-inner">
  <a href="/" class="logo"><img class="logo-light" src="/images/splicora-logo-wide.png?v=5" alt="Splicora" style="height:36px;"><img class="logo-dark" src="/images/splicora-logo-wide-dark.png?v=5" alt="Splicora" style="height:36px;display:none;"></a>
  <div class="nav-links">
    <a href="/">Home</a>
...
router.get('/privacy', optionalAuth, (req, res) => {
  ...
  <div class="legal-section">
    ...
    <h2>8. Your Rights</h2>
    <p>You have the right to access, update, or delete your personal information at any time. You may also request a copy of the data we hold about you. To exercise these rights, please contact us at hello@splicora.ai.</p>

    <h2>9. Changes to This Policy</h2>
    <p>We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page and updating the "Last updated" date.</p>

    <h2>10. Contact Us</h2>
    <p>If you have any questions about this Privacy Policy, please contact us at <a href="/contact">our contact page</a> or email hello@splicora.ai.</p>
  </div>
`));
});
...
router.get('/terms', optionalAuth, (req, res) => {
  ...
  <div class="legal-section">
    ...
    <h2>10. Contact</h2>
    <p>If you have any questions about these Terms, please contact us at <a href="/contact">our contact page</a> or email hello@splicora.ai.</p>
  </div>
`));
});
...
router.get('/cookies', optionalAuth, (req, res) => {
  ...
  <div class="legal-section">
    ...
    <h2>7. Contact Us</h2>
    <p>If you have questions about our use of cookies, please contact us at <a href="/contact">our contact page</a> or email hello@splicora.ai.</p>
  </div>
`));
});
