  ...
  <div class="dashboard">
    ...
    <main class="main-content">
      <div class="page-header">
        <h1><img src="/images/section-icons/A-5.png" alt="" style="height:36px;width:36px;vertical-align:middle;margin-right:8px;border-radius:8px;display:inline-block">AI Hooks</h1>
