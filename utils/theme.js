...
function getBaseCSS() {
  return `
    :root{--primary:#6C3AED;--primary-light:#8B5CF6;--dark:#0a0a0a;--dark-2:#111111;--surface:#161616;--surface-light:#1e1e1e;--text:#FFF;--text-muted:#A0AEC0;--text-dim:#718096;--gradient-1:linear-gradient(90deg,#7C3AED 0%,#A855F7 30%,#EC4899 100%);--border-subtle:1px solid rgba(255,255,255,0.06);--success:#10B981;--warning:#F59E0B;--error:#EF4444}
...
function getSidebar(activePage, user, teamPermissions) {
  ...
  const allLinks = [
    ...
    { href: '/dashboard/analytics', icon: '<img src="/images/dashboard-icons/analytics.png?v=2" alt="" style="width:20px;height:20px;">', label: 'Analytics', key: 'analytics', perm: 'view_analytics' },
    // --- Account ---
  ];
